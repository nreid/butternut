...
INDIR=../results/aligned_jcinerea/
...
POPMAP=../meta/popmap_cinerea.txt

cat ../meta/retained_samples.txt | sed 's/$/_jcinerea\tpop/' >$POPMAP
...
ALIGNDIR=../results/aligned_jcinerea
BAMDICT=../results/aligned_jcinerea/19DNA142C08_jcinerea.bam
